...
import HTDashboardDefault from '../../HumidityTemperatureDashboardDefault/HumidityTemperatureDashboardDefault';
      ...
      <ExpansionPanel>
        ...
        >
          ...
          <Hidden mdDown>
            ...
            <Typography className={classes.information}>
              Current Humidity : {sensor.currentHumidity}
            </Typography>
          </Hidden>
        </ExpansionPanelSummary>
