...
import { getHumidityChartData } from 'store/actions';
...
const ChartComponent = (props) => {
  ...
  const data = useSelector((state) => state.humidity.humidity[index].charts.data);
  const labels = useSelector((state) => state.humidity.humidity[index].charts.labels);
  const isLoading = useSelector((state) => state.humidity.humidity[index].charts.isLoading);
  ...
  useEffect(() => {
    dispatch(getHumidityChartData(chartName, chartType,id));
  ...
  const handleChangeType = (event) => {
    ...
    dispatch(getHumidityChartData(event.target.value, chartType,id));
  ...
  const handleChangeRange = (event) => {
    ...
    dispatch(getHumidityChartData(chartName, event.target.value, id));
  };
                ...
                >
                  ...
                  >
                    <div className={classes.inner}>
                      {chartName === 'temperature' || chartName ==='humidity' && isLoading === false ? 
                        <SingleLineChart
