...
import { setRoutine } from 'store/actions/geyserAction';
import DeleteIcon from '@material-ui/icons/Delete';
import { Switch } from '@material-ui/core';
import { delete_Routine } from 'store/actions/geyserAction';
...
const RoutineComponent = (props) => {
  ...
  const handleChange = (event) => {
    if(sensor.system_status === true)
    {
      ...
      dispatch(setRoutine(routine._id, startTime, endTime, event.target.checked));
    }
    else
    {
