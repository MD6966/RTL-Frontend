...
import { getTableData } from 'store/actions/geyserAction';
...
const Table = (props) => {
  ...
  const  data = useSelector((state) => state.geyser.geyser[index].logs.data);
  const title = useSelector((state) => state.geyser.geyser[index].logs.title);
  const  columns = useSelector((state) => state.geyser.geyser[index].logs.columns);
  
 
  const isLoading = useSelector(
    (state) => state.geyser.geyser[index].logs.isLoading
  );
