...
import { setGeyserControl } from 'store/actions/geyserHybridAction';
...
const GeyserHybridStatus = (props) => {
  ...
  const geyserLoading = useSelector((state) => state.geyserhybrid.moduleloading);
...
GeyserHybridStatus.propTypes = {
  className: PropTypes.string
};

export default GeyserHybridStatus;
