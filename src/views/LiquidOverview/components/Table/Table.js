...
const Table = (props) => {
  ...
  const isLoading = useSelector((state) => state.lms.lms[index].logs.isLoading);
      ...
      <Grid item lg={6} sm={12} xl={6} xs={12}>
        <FormControl className={classes.results} fullWidth variant="outlined">
          ...
          <Select
            ...
            <MenuItem value="do">Dissolved Oxygen Logs</MenuItem>
            <MenuItem value="temperature">Temperature Logs</MenuItem>
            <MenuItem value="aerator">Aerator Status Logs</MenuItem>
            <MenuItem value="motor">Motor Status Logs</MenuItem>
          </Select>
        </FormControl>
      </Grid>
