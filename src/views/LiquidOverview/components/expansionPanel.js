...
import LiquidDashboardDefault from '../../LiquidDashboardDefault/LiquidDashboardDefault';
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          <Hidden mdDown>
            ...
            <Typography className={classes.information}>
              Motor Status : {sensor.motor}
            </Typography>
            <Typography className={classes.information}>
              Aerator Status : {sensor.aerator}
            </Typography>
            <Typography className={classes.information}>
        ...
        <ExpansionPanelDetails>
          <Grid alignItems="center" container direction="row" justify="center">
            ...
            <Grid item md={12} xl={12} xs={12}>
              {index === 0 ? (
                <LiquidDashboardDefault sensor={sensor} settings={settings} />
              ) : index === 1 ? (
                <Table sensor={sensor} />
              ) : index === 2 ? (
