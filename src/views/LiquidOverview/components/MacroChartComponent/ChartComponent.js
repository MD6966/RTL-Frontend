...
const ChartComponent = (props) => {
  ...
  const handleChangeType = (event) => {
    ...
    if (event.target.value === 'ph') {
      ...
      setTitle('Motor Status Count');
      setType('bar');
    } else if (event.target.value === 'aerator') {
      setTitle('Aerator Status Count');
      setType('bar');
      ...
      setType('line');
    } else if (event.target.value === 'do') {
      setTitle('Average Dissolved Oxygen');
      setType('line');
    }
  };
        ...
        <Grid item md={6} sm={12} xl={6} xs={12}>
          <FormControl className={classes.root} variant="outlined">
            ...
            <Select
              ...
              <MenuItem value="temperature">Average Temperature Chart</MenuItem>
              <MenuItem value="aerator">Aerator Status Chart</MenuItem>
              <MenuItem value="motor">Motor Status Chart</MenuItem>
              <MenuItem value="do">Dissolved Oxygen Chart</MenuItem>
            </Select>
          </FormControl>
