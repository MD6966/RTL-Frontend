...
import Wt_DashboardDefault from 'views/WtDashboardDefault';
      ...
      <ExpansionPanel>
        ...
        >
          ...
          <Hidden mdDown>
            ...
            <Typography className={classes.information}>
              Forced Motor : {sensor.motor}
            </Typography>
            <Typography className={classes.information}>
              Fill Level Upper Tank : {sensor.fillLevel}
            </Typography>
            <Typography className={classes.information}>
            Fill Level Lower Tank : {sensor.fillLevel1}
            </Typography>
          </Hidden>
        </ExpansionPanelSummary>
