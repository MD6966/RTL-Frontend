...
import { get_gas_sensor } from 'store/actions/gasAction';
...
const GasOverview = () => {
  ...
  const isLoading = useSelector((state) => state.gas.generalLoading);
  ...
  // console.log('++++++++++++++++++++++++++++++++++++++++++_______________________________',user_id)
  ...
  useEffect(() => {
    if (index === 0) {
      dispatch(get_gas_sensor(user_id));
    }
